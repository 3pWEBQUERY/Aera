...
export function createPrismaMock() {
  ...
  return {
    ...
    newsletterConsent: model(),
    newsletterConsentEvent: model(),
    ...
    storageObject: model(),
    storageUploadReservation: model(),
    pendingCreatorCheckout: model(),
    stripeWebhookEvent: model(),
    cronJobHeartbeat: model(),
    dataDeletionJob: model(),
    objectDeletionTask: model(),
    storageReconciliationState: model(),
    billingRetentionRecord: model(),
    auditLog: model(),
