                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      sel
                        ...
                        : "border-slate-200 hover:border-slate-300 hover:bg-[var(--action-soft)]",
                    )}
                  >
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        sel ? "border-[var(--action-strong)] bg-white ring-2 ring-[var(--action-strong)]" : "border-slate-200 bg-white hover:border-slate-300",
                      )}
                    >
