 ...
 *
 * WORTGLEICHE Kopie von Aeras `lib/aeli-link-code.ts`. Die beiden Apps werden
 * getrennt ausgeliefert und können sich keine Datei teilen; dass die Regeln
 * dieselben bleiben, sichert ein Test auf Aera-Seite ab
 * (tests/aeli-integration.test.ts), der beide Dateien vergleicht.
 *
